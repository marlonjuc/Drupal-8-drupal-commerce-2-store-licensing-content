...
(isset($context["add_bundle_message"]) ? $context["add_bundle_message"] : null))) {
    ...
    ";
            // line 25
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["add_bundle_message"]) ? $context["add_bundle_message"] : null), "html", null, true));
            echo "
  </p>
";
        }
    ...
    {
        return new Twig_Source("", "core/themes/seven/templates/entity-add-list.html.twig", "/Users/mulate1/Sites/devdesktop/nexus-event-cams-store/core/themes/seven/templates/entity-add-list.html.twig");
    }
}
