...
class __TwigTemplate_3e303465195df819a510197184770c9be3369e17340928a1b3c2d728d69b51f7 extends Twig_Template
{
  ...
  <tr>
    <td>
      <table style=\"margin-left: auto; margin-right: auto; max-width: 768px; text-align: center;\">
        ...
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute((isset($context["order_entity"]) ? $context["order_entity"] : null), "getStore", array()), "label", array()), "html", null, true));
        echo "</a>
          </td>
        </tr>
        </tbody>
      ...
      <table style=\"text-align: center; min-width: 450px; margin: 5px auto 0 auto; border: 1px solid #cccccc; border-radius: 5px; padding: 40px 30px 30px 30px;\">
        ...
        <tr>
          <td style=\"font-weight: bold; padding-top:15px; padding-bottom: 15px; text-align: left; border-top: 1px solid #cccccc; border-bottom: 1px solid #cccccc\">
            ";
        // line 43
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Order #@number details:", array("@number" => $this->getAttribute((isset($context["order_entity"]) ? $context["order_entity"] : null), "getOrderNumber", array())))));
        echo "
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>
            ";
        // line 69
        if (((isset($context["billing_information"]) ? $context["billing_information"] : null) || (isset($context["shipping_information"]) ? $context["shipping_information"] : null))) {
            // line 70
            echo "            <table style=\"width: 100%; padding-top:15px; padding-bottom: 15px; text-align: left; border-top: 1px solid #cccccc; border-bottom: 1px solid #cccccc\">
              ...
              <tr>
                ";
            // line 73
            if ((isset($context["shipping_information"]) ? $context["shipping_information"] : null)) {
                // line 74
            ...
            // line 76
            echo "                ";
            if ((isset($context["billing_information"]) ? $context["billing_information"] : null)) {
                // line 77
                echo "                  <td style=\"padding-top: 5px; font-weight: bold;\">";
        ...
        <tr>
          <td>
            <p style=\"margin-bottom: 0;\">
              ";
        // line 116
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Subtotal: @subtotal", array("@subtotal" => $this->env->getExtension('Drupal\commerce_price\TwigExtension\PriceTwigExtension')->formatPrice($this->getAttribute((isset($context["totals"]) ? $context["totals"] : null), "subtotal", array()))))));
        echo "
            </p>
          </td>
        </tr>
        ...
        echo "        <tr>
          <td>
            <p style=\"font-size: 24px; padding-top: 15px; padding-bottom: 5px;\">
              ";
        // line 132
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Order Total: @total", array("@total" => $this->env->getExtension('Drupal\commerce_price\TwigExtension\PriceTwigExtension')->formatPrice($this->getAttribute((isset($context["order_entity"]) ? $context["order_entity"] : null), "getTotalPrice", array()))))));
        echo "
            </p>
          </td>
        </tr>
...
";
    ...
    public function block_shipping_information($context, array $blocks = array())
    {
        // line 84
        echo "                      ";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["shipping_information"]) ? $context["shipping_information"] : null), "html", null, true));
        echo "
                    ";
    }
    ...
    public function block_billing_information($context, array $blocks = array())
    {
        // line 91
        echo "                      ";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["billing_information"]) ? $context["billing_information"] : null), "html", null, true));
        echo "
                    ";
    }
    ...
    public function block_payment_method($context, array $blocks = array())
    {
        // line 103
        echo "                      ";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["payment_method"]) ? $context["payment_method"] : null), "html", null, true));
        echo "
                    ";
    }
    ...
    {
        return new Twig_Source("", "modules/commerce/modules/order/templates/commerce-order-receipt.html.twig", "/Users/mulate1/Sites/devdesktop/nexus-event-cams-store/modules/commerce/modules/order/templates/commerce-order-receipt.html.twig");
    }
}
